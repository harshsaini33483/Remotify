...
public class Keyboard extends Fragment {
    ...
    private Button ctrlButton, altButton, shiftButton, enterButton, tabButton, escButton, backspaceButton,capslockButton;
    ...
    private Button spaceButton, bButton, mButton,leftpar,rightpar,curLeftButton,curRightButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle(getResources().getString(R.string.controlKeyboard));
        ...
        public void onClick(View v) {
            int id=v.getId();
                ...
                switch (id) {
                    ...
                    case R.id.parleftButton:
                        message = "(";
                        break;

                    case R.id.parrightButton:
                        message = ")";
                        break;
                    case R.id.curleftButton:
                        message = "{";
                        break;

                    case R.id.currightButton:
                        message = "}";
                        break;
   ...
   public void initializeButton(View rootView)
   {
       ...
       capslockButton=(Button) rootView.findViewById(R.id.capslockButton);
       ...
       leftpar = (Button) rootView.findViewById(R.id.parleftButton);
       rightpar = (Button) rootView.findViewById(R.id.parrightButton);
       curLeftButton = (Button) rootView.findViewById(R.id.curleftButton);
       curRightButton = (Button) rootView.findViewById(R.id.currightButton);
   ...
   {
       leftpar.setOnClickListener(clickListener);
       rightpar.setOnClickListener(clickListener);
       curRightButton.setOnClickListener(clickListener);
       curLeftButton.setOnClickListener(clickListener);
       capslockButton.setOnClickListener(clickListener);
